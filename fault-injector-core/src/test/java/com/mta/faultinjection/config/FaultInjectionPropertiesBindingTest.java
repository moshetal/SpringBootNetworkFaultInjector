...
class FaultInjectionPropertiesBindingTest {
    ...
    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            .withConfiguration(
                    AutoConfigurations.of(com.mta.faultinjection.autoconfig.FaultInjectionAutoConfiguration.class));

    @Test
    void bindsEnabledFlag() {
        contextRunner.withPropertyValues("fault.injection.enabled=true").run(ctx -> {
